...
### getTweetById(id:string,queryParamters:Object):Tweet
ツイートIDからツイートを取得します。
...
### getTweetByURL(url:string,queryParamters:Object):Tweet
URLからツイートを取得します。
#### Twitterドキュメント
https://developer.twitter.com/en/docs/twitter-api/tweets/lookup/api-reference
#### 引数
...
### postTweet(payload:Object):ClientTweet
ツイートを投稿します。
#### Twitterドキュメント
...
### getListById(id:string,queryParamters:Object):List
IDからリストを取得します。
### Twitterドキュメント
...
### getUserByUsername(username:string,queryParamters:Object):User
#### Twitterドキュメント
...
### uploadBigMedia(blob:Blob):Object
画像,動画をアップロードします。
#### Twitterドキュメント
